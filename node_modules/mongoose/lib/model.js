...
Model.prototype.$__save = function(options, callback) {
  ...
  _this.$__handleSave(options, function(error, result) {
    ...
    _this.emit('testDB', _this, numAffected);
...
Model.prototype.testDB = function(options, fn) {
 ...
 * @param {Schema} testSchema discriminator model schema
 * @api public
 */
    ...
    args.forEach(function(doc) {
      toExecute.push(function(callback) {
        ...
        if (toSave.$__original_save) {
          ...
          toSave.testDB({ __noPromise: true }, callbackWrapper);
        }
      });
    });
...
Model.compile = function compile(name, schema, collectionName, connection, base) {
  ...
  model.insertMany = model.hooks.createWrapper('insertMany',
